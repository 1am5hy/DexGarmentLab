...
def WearScarf(pos, ori, usd_path, env_dx, env_dy, ground_material_usd, validation_flag, record_vedio_flag, training_data_num, stage_1_checkpoint_num, stage_2_checkpoint_num, stage_3_checkpoint_num):
    
    env = WearScarf_Env(pos, ori, usd_path, env_dx, env_dy, ground_material_usd, record_vedio_flag, training_data_num, stage_1_checkpoint_num, stage_2_checkpoint_num, stage_3_checkpoint_num)
...
if __name__=="__main__":
    ...
    WearScarf(pos, ori, usd_path, env_dx, env_dy, args.ground_material_usd, args.validation_flag, args.record_vedio_flag, args.training_data_num, args.stage_1_checkpoint_num, args.stage_2_checkpoint_num, args.stage_3_checkpoint_num)
