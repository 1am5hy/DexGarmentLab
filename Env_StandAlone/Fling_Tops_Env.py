...
def FlingTops(pos, ori, usd_path, ground_material_usd, data_collection_flag, record_vedio_flag):

    env = FlingTops_Env(pos, ori, usd_path, ground_material_usd, record_vedio_flag)
    ...
    manipulation_points, indices, max_values = env.model.get_manipulation_points(input_pcd=pcd, index_list=[838,179]) 
    ...
    manipulation_points, indices, max_values = env.model.get_manipulation_points(input_pcd=pcd, index_list=[1635,954,838,179])
    ...
    if record_vedio_flag:
        if not os.path.exists("Data/Fling_Tops/vedio"):
            os.makedirs("Data/Fling_Tops/vedio")
        env.env_camera.create_mp4(get_unique_filename("Data/Fling_Tops/vedio/vedio", ".mp4"))
