...
class CollisionGroup:
    def __init__(self, stage, prim_path, helper_path: list = None, garment: bool = True, collide_with_garment: bool = True,
                 collide_with_robot: bool = True, garment_with_robot: bool = True):
        # get stage
        self.stage = stage
        self.prim_path = prim_path
        # ----------define garment_collision_group---------- #
        # path
        self.garment_group_path = self.prim_path + "/Collision_Group/garment_group"
        # collision_group
        ...
        if helper_path is not None:
            ...
            self.helper_group_path = self.prim_path + "/Collision_Group/helper_group"
        ...
        self.robot_group_path = self.prim_path + "/Collision_Group/robot_group"
        ...
        if garment:
            self.collectionAPI_garment.CreateIncludesRel().AddTarget(self.prim_path + "/Garment")
        else:
        ...
        self.collectionAPI_robot.CreateIncludesRel().AddTarget(self.prim_path + "/Robot")
        self.collectionAPI_robot.CreateIncludesRel().AddTarget(self.prim_path + "/Robot2")
    ...
    def add_collision(self, group_path: str, target: list, garment: bool = False,
                      robot: bool = False):
        self.group_path = self.prim_path +  "/Collision_Group/{}_group".format(group_path)
